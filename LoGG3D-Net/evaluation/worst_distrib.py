...
if __name__ == "__main__":
    ...
    # get seen descriptor
    input_file = open("/gpfswork/rech/dki/ujo91el/code/logg3dnet/evaluation/DCC/DCC_03/logg3d_descriptor.pickle", "rb")
