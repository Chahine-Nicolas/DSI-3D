...
class MulRanDataset(PointCloudDataset):
    ...
    def __init__(self,
        ...
        for drive_id in sequences:
            ...
            for query_id, start_time in enumerate(inames):
                ...
                dict_name[query_id] = inames[query_id]
                
        #with open('evaluation/classification/'+str(config.mulran_eval_seq)+'_Names_MulRanDataset.pkl', 'wb') as f:
            #pickle.dump(dict_name, f)
        #logging.info("save dict name : ok")
    ...
    def get_pointcloud_tensor(self, drive_id, pc_id):
        ...
        # print("self.int_norm",self.int_norm)
        if self.int_norm:
