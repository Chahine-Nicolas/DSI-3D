...
class Blip2QFormerModel(Blip2PreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            if self.acc % PRINT_ITER == 0  and False  :
                #import pdb; pdb.set_trace()             
